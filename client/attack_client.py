...
class AttackClient(metaclass= Singleton):
    ...
    def get_attack(self, id:int) -> Optional[AbstractAttack] :
        ...
        """
        req = requests.get(str(self.__HOST)+str(END_POINT)+'/'+str(id))
    ...
    def get_all_attack(self, limit:int=0, offset:int=0) -> List[AbstractAttack]:
        ...
        req = requests.get(str(self.__HOST)+str(END_POINT), params= params)
    ...
    def create_attack(self, attack:AbstractAttack)-> bool:
        ...
        req = requests.post(str(self.__HOST)+str(END_POINT)
                            , json=payload)
    ...
    def update_attack(self, attack:AbstractAttack)-> bool:
        ...
        req = requests.put(str(self.__HOST)+str(END_POINT)+'/'+str(attack.id)
                            , params=params
                            , json=payload)
    ...
    def delete_attack(self, attack:AbstractAttack) ->bool:
        ...
        :rtype: bool
        """
        req = requests.delete(str(self.__HOST)+str(END_POINT)+'/'+str(attack.name))
